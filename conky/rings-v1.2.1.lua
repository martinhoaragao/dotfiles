...
settings_table = {
    ...
    {
        name='platform coretemp.0 temp 1',
        arg='',
        max=110,
        bg_colour=0x000000,
        bg_alpha=0.8,
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route enp4s0}enp4s0${else}wlp3s0${endif}")

    settings_table[8]['arg']=iface
    settings_table[9]['arg']=iface
end
